...
import {getEvents, interested, notInterested} from '../../actions/event'
import Moment from 'react-moment'

const Events = ({auth, event, getEvents, interested, notInterested}) => {
...
export default connect(mapStateToProps,{getEvents, interested, notInterested})(Events)
